...
public class MCreatorMysticDimension extends Elementsinsanusnatura.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("insanusnatura:mysticdimension")
	public static final Item block = null;
	@GameRegistry.ObjectHolder("insanusnatura:mysticdimension_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;

	public MCreatorMysticDimension(Elementsinsanusnatura instance) {
		super(instance, 7);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ModTrigger().setUnlocalizedName("mysticdimension").setRegistryName("mysticdimension"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension mysticdimension is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("mysticdimension", "_mysticdimension", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("insanusnatura:mysticdimension", "inventory"));
	}
	...
	public static class WorldProviderMod extends WorldProvider {
		...
		public Vec3d getFogColor(float par1, float par2) {
			return new Vec3d(0.83137254902, 0.917647058824, 1);
		}
				...
				for (int j7 = -1; j7 <= 1; ++j7) {
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							boolean flag = k8 < 0;
							this.world.setBlockState(new BlockPos(k9, k10, k11), flag ? Blocks.DIAMOND_BLOCK.getDefaultState().getBlock()
			...
			for (int i8 = 0; i8 < 4; ++i8) {
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12), flag1 ? Blocks.DIAMOND_BLOCK.getDefaultState().getBlock()
				...
				for (int j1 = -2; j1 <= 2; ++j1) {
					for (int k1 = -2; k1 <= 2; ++k1) {
						for (int l1 = -1; l1 < 3; ++l1) {
							...
							int k2 = k + k1 * 0 - j1 * 1;
							boolean flag = l1 < 0;
							this.world.setBlockState(new BlockPos(i2, j2, k2), flag ? Blocks.DIAMOND_BLOCK.getDefaultState().getBlock()
									.getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("mysticdimension_portal");
			setRegistryName("mysticdimension_portal");
			setLightLevel(1F);
		}
		...
		public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random random) {
			for (int i = 0; i < 4; i++) {
				...
				world.spawnParticle(EnumParticleTypes.SPELL_WITCH, px, py, pz, vx, vy, vz);
			}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = MCreatorMysticStone.block.getDefaultState();
		private static final IBlockState STONE2 = MCreatorMysticDirt.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("insanusnatura:mysticplains")),};
