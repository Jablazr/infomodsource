...
public class ChunkGeneratorInsanusNatura implements IChunkGenerator {
    ...
    protected Biome biome = BiomeInit.MAGIC;
    protected IBlockState baseBlock = BlockInit.MAGICAL_GRASS.getDefaultState();
     ...
     */
    public ChunkGeneratorInsanusNatura(World worldIn)
    {
        // DEBUG
       ...
       // MapGenVillage.VILLAGE_SPAWN_BIOMES.add(BiomeInit.MAGIC);
