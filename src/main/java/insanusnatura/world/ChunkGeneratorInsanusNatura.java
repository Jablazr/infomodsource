...
public class ChunkGeneratorInsanusNatura implements IChunkGenerator {
    private static final IBlockState STONE = ModBlocks.MYSTIC_STONE.getDefaultState();
    private static final IBlockState STONE2 = ModBlocks.MYSTIC_DIRT.getDefaultState();
    ...
    public ChunkGeneratorInsanusNatura(World worldIn, long seed) {
