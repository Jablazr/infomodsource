...
public class MysticalWorkbenchRecipes {
    private class RecipeGroup {
        ...
        public RecipeGroup(ItemStack print, ItemStack instrument, ItemStack primary, ItemStack secondary, ItemStack result) {
            this.print = print;
    ...
    private MysticalWorkbenchRecipes() {
        addMysticalWorkbenchRecipe(new ItemStack(ItemInit.MUSICAL_PRINT),
                new ItemStack(ItemInit.FLUTE),
                new ItemStack(ItemInit.MAGENTA_FEATHER),
                new ItemStack(ItemInit.VINE_BRACELET),
                new ItemStack(ItemInit.MYSTICAL_FLUTE));
    }

    public ItemStack getMysticalWorkbenchResult(ItemStack print, ItemStack instrument, ItemStack primary, ItemStack secondary) {
    ...
    public void addMysticalWorkbenchRecipe(ItemStack print, ItemStack instrument, ItemStack primary, ItemStack secondary, ItemStack result) {
