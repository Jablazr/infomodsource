...
public class MysticalWorkbenchRecipes {
    ...
    private MysticalWorkbenchRecipes() {
        addMysticalWorkbenchRecipe(new ItemStack(ModItems.FLUTE), new ItemStack(ModItems.MAGENTA_FEATHER), new ItemStack(ModItems.MUSICAL_PRINT), new ItemStack(ModItems.MYSTICAL_FLUTE));
    }
