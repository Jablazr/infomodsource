...
public class MysticalWorkbenchRecipes {
    ...
    private MysticalWorkbenchRecipes() {
        addMysticalWorkbenchRecipe(new ItemStack(ModItems.MUSICAL_PRINT), // print
                new ItemStack(ModItems.FLUTE), // item1
                new ItemStack(ModItems.MAGENTA_FEATHER), // item2
                new ItemStack(ModItems.VINE_BRACELET), // item3
                new ItemStack(ModItems.MYSTICAL_FLUTE), // result
                0); // group + 1
